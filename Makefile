#############################################################################
# Makefile for building: plarerobox
# Generated by qmake (2.01a) (Qt 4.7.0) on: ?? 9? 9 15:01:21 2019
# Project:  plarerobox.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.7.0/bin/qmake -o Makefile plarerobox.pro
#############################################################################
...
INCPATH       = -I/usr/local/Trolltech/Qt-4.7.0/mkspecs/linux-g++-64 -I. -I/usr/local/Trolltech/Qt-4.7.0/include/QtCore -I/usr/local/Trolltech/Qt-4.7.0/include/QtGui -I/usr/local/Trolltech/Qt-4.7.0/include -I. -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1 -Wl,-rpath,/usr/local/Trolltech/Qt-4.7.0/lib
LIBS          = $(SUBLIBS)  -L/usr/local/Trolltech/Qt-4.7.0/lib -lQtGui -L/usr/local/Trolltech/Qt-4.7.0/lib -L/usr/X11R6/lib64 -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: plarerobox.pro  /usr/local/Trolltech/Qt-4.7.0/mkspecs/linux-g++-64/qmake.conf /usr/local/Trolltech/Qt-4.7.0/mkspecs/common/g++.conf \
		/usr/local/Trolltech/Qt-4.7.0/mkspecs/common/unix.conf \
		/usr/local/Trolltech/Qt-4.7.0/mkspecs/common/linux.conf \
		/usr/local/Trolltech/Qt-4.7.0/mkspecs/qconfig.pri \
		/usr/local/Trolltech/Qt-4.7.0/mkspecs/modules/qt_webkit_version.pri \
	...
	$(QMAKE) -o Makefile plarerobox.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/plarerobox1.0.0 || $(MKDIR) .tmp/plarerobox1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/plarerobox1.0.0/ && $(COPY_FILE) --parents widget.h lrc.h .tmp/plarerobox1.0.0/ && $(COPY_FILE) --parents image.qrc .tmp/plarerobox1.0.0/ && $(COPY_FILE) --parents main.cpp widget.cpp lrc.cpp .tmp/plarerobox1.0.0/ && $(COPY_FILE) --parents widget.ui .tmp/plarerobox1.0.0/ && (cd `dirname .tmp/plarerobox1.0.0` && $(TAR) plarerobox1.0.0.tar plarerobox1.0.0 && $(COMPRESS) plarerobox1.0.0.tar) && $(MOVE) `dirname .tmp/plarerobox1.0.0`/plarerobox1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/plarerobox1.0.0
...
moc_widget.cpp: widget.h
	/usr/local/Trolltech/Qt-4.7.0/bin/moc $(DEFINES) $(INCPATH) widget.h -o moc_widget.cpp
...
qrc_image.cpp: image.qrc \
		...
		1192052.gif \
		1222643.gif
	/usr/local/Trolltech/Qt-4.7.0/bin/rcc -name image image.qrc -o qrc_image.cpp
...
ui_widget.h: widget.ui
	/usr/local/Trolltech/Qt-4.7.0/bin/uic widget.ui -o ui_widget.h
...
lrc.o: lrc.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o lrc.o lrc.cpp
